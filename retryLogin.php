<html lang="en" dir="ltr">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<div class="navbar-nav ml-auto">
     ...
     <a href='login.php#section2' class='btn btn-outline-light'>Login</a>
...
<div class="main center">
  ...
  <div class="container">
    <h3 class = "ttl">Please enter a valid username or password<h/3>
    <div class = "padding center"></div>
    <button class="btn btn-secondary mb-3" type="button" onclick="window.location.href='login.php#section2';">Retry</button>
