...
<body>
  ...
  <h1>Manage Devices</h1>
    ...
    <button type="button" class="btn btn-primary" onclick="window.location.href='registerDevice.php';">Add New Device</button>
	</div>
...
$('#refresh').load('devicesAuto.php');
$(document).ready(function(){
    setInterval(function(){
    $('#refresh').load('devicesAuto.php'); //load php script that loads table
    },5000); //delay 5000ms
});
</script> 
