...
<body>
  ...
  <button type="submit" class="btn btn-secondary" onclick="window.location.href='recipes.php';">Back</button>
  ...
  <div  id="section4"></div>
<form action = "renameRecipeQuery.php" method = "POST">
    ...
    <?php
        ...
        <h5>Name of recipe you want to rename</h5>
        <div class="mb-3">        
        ...
        <div class="mb-3">        
            <input type="text" class="form-control col-8 mx-auto" name = "NewName" placeholder="Type new name of recipe"required>
        </div>
