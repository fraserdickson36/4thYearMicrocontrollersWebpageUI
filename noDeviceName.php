...
<div class="main center">
  ...
  <div class="container">
    <h3 class = "ttl">There is no device with that name, please try again with a different name!<h/3>
    <div class = "padding center"></div>
    <button class="btn btn-secondary mb-3" type="button" onclick="window.location.href='devices.php';">Go back...</button>
